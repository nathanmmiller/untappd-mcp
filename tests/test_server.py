...
from src.untappd_mcp.server import mcp
from untappd_mcp.server import parse_result
...
async def test_call_search_for_beer_tool(client: Client, mocker: MockerFixture) -> None:
    ...
    mocker.patch(BASE_PATH + "CLIENT_ID", "some-client-id")
    mocker.patch(BASE_PATH + "CLIENT_SECRET", "some-client-secret")
